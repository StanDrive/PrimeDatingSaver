...
{
    /// <summary>
    /// MenServiceController
    /// </summary>
    [RoutePrefix("api/men")]
    [BasicAuthenticationFilter]
    public class MenServiceController : BaseServiceController<Men>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MenServiceController"/> class.
        /// </summary>
        /// <param name="entityService">The entity service.</param>
        /// <param name="logger">The logger.</param>
        public MenServiceController(IEntityService<Men> entityService, ILogger logger)
        ...
        [HttpPost]
        [Route("Insert")]
        public override HttpResponseMessage Insert(Men entity)
        {
        ...
        [HttpPost]
        [Route("insertrange")]
        public override HttpResponseMessage InsertRange(List<Men> entities)
        {
        ...
        [HttpPut]
        [Route("update")]
        public override HttpResponseMessage Update(Men entity)
        {
