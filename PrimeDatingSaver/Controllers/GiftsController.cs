...
namespace PrimeDatingSaver.Controllers
{
    ...
    public class GiftsController : BaseServiceController<Gifts>
    {
        ...
        [HttpPost]
        [Route("Insert")]
        public override HttpResponseMessage Insert(Gifts entity)
        {
        ...
        [HttpPost]
        [Route("insertrange")]
        public override HttpResponseMessage InsertRange(List<Gifts> entities)
        {
        ...
        [HttpPut]
        [Route("update")]
        public override HttpResponseMessage Update(Gifts entity)
        {
