...
namespace PrimeDatingSaver.Controllers
{
    ...
    /// </summary>
    [RoutePrefix("api/hr")]
    public class HrServiceController : BaseServiceController<HR>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="HrServiceController"/> class.
        /// </summary>
        /// <param name="entityService">The entity service.</param>
        /// <param name="logger">The logger.</param>
        public HrServiceController(IEntityService<HR> entityService, ILogger logger)
        ...
        [HttpPost]
        [Route("Insert")]
        public override HttpResponseMessage Insert(HR entity)
        {
        ...
        [HttpPost]
        [Route("insertrange")]
        public override HttpResponseMessage InsertRange(List<HR> entities)
        {
        ...
        [HttpPut]
        [Route("update")]
        public override HttpResponseMessage Update(HR entity)
        {
