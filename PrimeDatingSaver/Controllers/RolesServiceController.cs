...
namespace PrimeDatingSaver.Controllers
{
    ...
    public class RolesServiceController : BaseServiceController<Roles>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="RolesServiceController"/> class.
        /// </summary>
        /// <param name="entityService">The entity service.</param>
        /// <param name="logger">The logger.</param>
        public RolesServiceController(IEntityService<Roles> entityService, ILogger logger)
        ...
        [HttpPost]
        [Route("Insert")]
        public override HttpResponseMessage Insert(Roles entity)
        {
        ...
        [HttpPost]
        [Route("insertrange")]
        public override HttpResponseMessage InsertRange(List<Roles> entities)
        {
        ...
        [HttpPut]
        [Route("update")]
        public override HttpResponseMessage Update(Roles entity)
        {
