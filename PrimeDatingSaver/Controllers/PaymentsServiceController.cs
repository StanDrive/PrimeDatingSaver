...
namespace PrimeDatingSaver.Controllers
{
    ...
    public class PaymentsServiceController : BaseServiceController<Payments>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PaymentsServiceController"/> class.
        /// </summary>
        /// <param name="entityService">The entity service.</param>
        /// <param name="logger">The logger.</param>
        public PaymentsServiceController(IEntityService<Payments> entityService, ILogger logger)
        ...
        [HttpPost]
        [Route("Insert")]
        public override HttpResponseMessage Insert(Payments entity)
        {
        ...
        [HttpPost]
        [Route("insertrange")]
        public override HttpResponseMessage InsertRange(List<Payments> entities)
        {
        ...
        [HttpPut]
        [Route("update")]
        public override HttpResponseMessage Update(Payments entity)
        {
