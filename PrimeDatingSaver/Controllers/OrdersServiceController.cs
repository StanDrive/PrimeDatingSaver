...
namespace PrimeDatingSaver.Controllers
{
    ...
    public class OrdersServiceController : BaseServiceController<Orders>
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="OrdersServiceController"/> class.
        /// </summary>
        /// <param name="entityService">The entity service.</param>
        /// <param name="logger">The logger.</param>
        public OrdersServiceController(IEntityService<Orders> entityService, ILogger logger)
        ...
        [HttpPost]
        [Route("Insert")]
        public override HttpResponseMessage Insert(Orders entity)
        {
        ...
        [HttpPost]
        [Route("insertrange")]
        public override HttpResponseMessage InsertRange(List<Orders> entities)
        {
        ...
        [HttpPut]
        [Route("update")]
        public override HttpResponseMessage Update(Orders entity)
        {
